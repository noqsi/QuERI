...
Most of the analog circuitry in the MPU uses a 4\ V reference voltage, $VREF$, with a 2\ V "half scale" voltage, $VHS$, used as a virtual ground, allowing it to work from a single 5V supply.
